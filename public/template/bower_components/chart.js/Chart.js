...
(function () {
    ...
    Chart.Arc = Chart.Element.extend({
        inRange: function (chartX, chartY) {
            ...
            var betweenAngles =
                endAngle < startAngle
                    ? pointRelativeAngle <= endAngle ||
                      pointRelativeAngle >= startAngle
                    : pointRelativeAngle >= startAngle &&
                      pointRelativeAngle <= endAngle;
                ...
                if (!this.lineArc) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        ...
                        if (
                            ...
                            outerPosition = this.getPointPosition(
                                i,
                                centerOffset
                            );
                            ctx.beginPath();
                        ...
                        if (
                            ...
                            var previousOuterHalfway = {
                                x:
                                    (previousOuterPosition.x +
                                        outerPosition.x) /
                                    2,
                                y:
                                    (previousOuterPosition.y +
                                        outerPosition.y) /
                                    2,
                            };
                            ...
                            ctx.moveTo(this.xCenter, this.yCenter);
                            ctx.lineTo(
                                previousOuterHalfway.x,
                                previousOuterHalfway.y
                            );
                            ctx.lineTo(outerPosition.x, outerPosition.y);
                            ...
                            datasetObject.bars.push(
                                new this.BarClass({
                                    ...
                                    highlightStroke: dataset.highlightStroke
                                        ? typeof dataset.highlightStroke ==
                                          "object"
