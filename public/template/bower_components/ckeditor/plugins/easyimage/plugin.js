...
(function () {
    ...
    function n(a, c) {
        ...
        (function (b) {
            ...
            a.on("beforeCommandExec", function (d) {
                c(d.data.name, b) &&
                    d.data.command.style.checkActive(
                        d.editor.elementPath(),
                        a
                    ) &&
                    (d.cancel(), a.focus());
            });
    ...
    function r(a, c) {
        ...
        a.plugins.link &&
            (b = CKEDITOR.plugins.imagebase.addFeature(a, "link", b));
