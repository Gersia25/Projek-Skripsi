...
(function () {
        ...
        function h() {
            ...
            if (this.deflated)
                (this.widget = a.widgets.initOn(
                    ...
                    this.widget.inline &&
                        !new CKEDITOR.dom.elementPath(this.widget.wrapper, d)
                            .block &&
                        ((d = c.createElement(
            ...
            if (
                ...
                (b(a)
                    ? ("div" == c &&
                      ...
                      (g.align = "center"),
                      (f =
                          a.getFirst("img") || a.getFirst("a").getFirst("img")))
        ...
        g.on("mousedown", function (c) {
            ...
            var f = a.parts.image,
                B = (function () {
                    ...
                    a.width = Math.max(
                        "natural" === a.width ? c.width : a.width,
                        15
                    );
                    a.height = Math.max(
                        "natural" === a.height ? c.height : a.height,
                        15
                    );
                    return a;
                })(),
            ...
            var b = CKEDITOR.on("dialogDefinition", function (b) {
                ...
                if ("link" == b.name) {
                    ...
                    b.onOk = function () {
                        ...
                        if (
                            b &&
                            (b.inline ? !b.wrapper.getAscendant("a") : 1)
                        ) {
                            var c = {};
    ...
    CKEDITOR.plugins.image2 = {
        stateShifter: function (a) {
                            ...
                            f
                                ? ((f = CKEDITOR.dom.element.createFromHtml(
                                      P.output({
                                          captionedClass: d,
                                          captionPlaceholder:
                                              a.lang.image2.captionPlaceholder,
                                      }),
                                      e
                                  )),
                                  h(f, b.element),
                        ...
                        if (b.changed.link) {
                            ...
                            d
                                ? (c ||
                                  ...
                                  d.removed.length &&
                                      (k || g).removeAttributes(d.removed))
                                : ((d = g.findOne("img")),
                                  d.replace(g),
                                  (k = d));
                            h && (b.element = k);
            ...
            return function (a) {
                ...
                for (c = 0; c < f.length; c++)
                    (b = f[c]),
                        (a.changed[b] = a.oldData
                            ? a.oldData[b] !== a.newData[b]
                            : !1);
                for (c = 0; c < f.length; c++)
                    (b = f[c]),
                        k[b](a, a.oldData ? a.oldData[b] : null, a.newData[b]);
                a.inflate();
            };
        },
        checkHasNaturalRatio: function (a) {
            ...
            a = this.getNatural(a);
            return (
                Math.round((b.clientWidth / a.width) * a.height) ==
                    b.clientHeight ||
                Math.round((b.clientHeight / a.height) * a.width) ==
                    b.clientWidth
            );
        },
