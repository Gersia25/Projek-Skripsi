    ...
    CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
        ...
        function c(a, e) {
            var b = d.children.length,
                ...
                g =
                    a &&
                    v.getRule(m[a], e ? "breakBeforeClose" : "breakBeforeOpen");
            f && (b || c || g) && f--;
            f && a in A && f++;
            for (; f && f--; )
                    ...
                    a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function (a, e) {
                        if (void 0 !== e && e.length) f++;
                            ...
                            a.replace(r, function (e, c) {
                                ...
                                k(
                                    new CKEDITOR.htmlParser.element("smiley", {
                                        desc: B[e],
                                    }),
                                    d
                                );
        ...
        init: function (a) {
            ...
            k.addRules({
                elements: {
                    ...
                    a: function (a) {
                        a.attributes.href ||
                            (a.attributes.href = a.children[0].value);
                    },
                    smiley: function (a) {
                        a.name = "img";
                    ...
                    elements: {
                        $: function (b) {
                            ...
                            if (d in x) d = x[d];
                                ...
                                if ((f = h.color))
                                    (d = "color"),
                                        (f = CKEDITOR.tools.convertRgbToHex(f));
                                else {
                                    if ((f = h["font-size"]))
                                        if ((c = f.match(/(\d+)%$/)))
                                            (f = c[1]), (d = "size");
                                ...
                                if (
                                    h &&
                                    -1 != h.indexOf(a.config.smiley_path) &&
                                    c
                                )
            ...
            a._.elementsPath &&
                ...
                b.push(function (b) {
                    var k = b.getName(),
                        e = m[k] || !1;
                    "link" == e &&
                    0 === b.getAttribute("href").indexOf("mailto:")
                        ? (e = "email")
                        : "span" == k
