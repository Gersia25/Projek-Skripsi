...
(function () {
    function e(a, b) {
        ...
        this.options &&
            ...
            (this.options.priority =
                CKEDITOR.plugins.balloontoolbar.PRIORITY.MEDIUM);
        this._loadButtons();
    }
    function g(a) {
        this.editor = a;
    ...
    CKEDITOR.ui.balloonToolbar.prototype.destroy = function () {
        for (var a in this._items)
            this._items[a].destroy && this._items[a].destroy(),
                this.deleteItem(a);
    ...
    CKEDITOR.plugins.add("balloontoolbar", {
        ...
        beforeInit: function (a) {
            m ||
                ...
                (m = !0));
            a.balloonToolbars =
                new CKEDITOR.plugins.balloontoolbar.contextManager(a);
        },
        init: function (a) {
            a.balloonToolbars =
                new CKEDITOR.plugins.balloontoolbar.contextManager(a);
            l ||
                ...
                (CKEDITOR.ui.balloonToolbarView.prototype.reposition =
                    function () {
                        this.rect.visible &&
                ...
                (CKEDITOR.ui.balloonToolbarView.prototype._getAlignments =
                    function (a, c, e) {
                        a =
                            CKEDITOR.ui.balloonPanel.prototype._getAlignments.call(
                                this,
                                a,
                                c,
                                e
                ...
                (CKEDITOR.ui.balloonToolbarView.prototype.destroy =
                    function () {
                            ...
                            function (f) {
                                ...
                                d
                                    ...
                                    : (CKEDITOR.ui.richCombo &&
                                      ...
                                      ((d = !0),
                                      c.push(
                                          '\x3cspan class\x3d"cke_toolgroup"\x3e'
                                      ));
                ...
                (CKEDITOR.ui.balloonToolbarView.prototype.attach = function (
                    a,
                    c
                ) {
