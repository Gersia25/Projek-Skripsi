...
(function () {
    ...
    function r(b, d) {
        ...
        0 > a.indexOf("px") &&
            (a =
                a in l && "none" != b.getComputedStyle("border-style")
                    ? l[a]
                    : 0);
        ...
        CKEDITOR.tools.array.forEach(b.$.rows, function (f, B) {
            ...
            for (
                ...
                var h = new CKEDITOR.dom.element(f.cells[m]),
                    p =
                        f.cells[m + 1] &&
                        new CKEDITOR.dom.element(f.cells[m + 1]),
                    e = e + (h.$.colSpan || 1),
                    t,
                    u,
                    ...
                    function (a) {
                        ...
                        if (f.type == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (d && d.move(k, e)) z(a);
                                ...
                                f.is("table") ||
                                f.getAscendant(
                                    { thead: 1, tbody: 1, tfoot: 1 },
                                    1
                                )
                            )
                                if (
                                    ((a = f.getAscendant("table", 1)),
                                    b.editable().contains(a))
                                ) {
                                    (f =
                                        a.getCustomData(
                                            "_cke_table_pillars"
