                ...
                elements: {
                    ...
                    td: function (a) {
                        ...
                        var c = m.parseCssText(a.attributes.style, !0),
                            e = c.border
                                ? CKEDITOR.tools.style.border.fromCssRule(
                                      c.border
                                  )
                                : {},
                        ...
                        c.background &&
                            ((f = CKEDITOR.tools.style.parse.background(
                                c.background
                            )),
                            f.color &&
                        ...
                        for (var g in e)
                            (f = c[g]
                                ? CKEDITOR.tools.style.border.fromCssRule(c[g])
                                : e[g]),
                                "none" === f.style
                                    ? k.setStyle(a, g, "none")
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        setListStart: function (a) {
            ...
            switch (a.attributes["cke-list-style-type"]) {
                ...
                case "upper-roman":
                    a.attributes.start =
                        h.toArabic(h.getSubsectionSymbol(b[c])) - c;
                    break;
                case "lower-alpha":
                case "upper-alpha":
                    a.attributes.start =
            ...
            for (a = 0; a < g.length; a++) {
                ...
                for (e = 0; e < k.length; e++) {
                    ...
                    for (d = c.attributes["cke-list-level"]; d > l.length; ) {
                        ...
                        n = m;
                        d == l.length &&
                            h.setListSymbol(m, c.attributes["cke-symbol"], d);
                    }
                    for (; d < l.length; )
                        l.pop(),
                            (n = l[l.length - 1]),
                ...
                for (e = 0; e < k.length; e++)
                    this.determineListItemValue(k[e]);
            }
        ...
        groupLists: function (a) {
            ...
            for (b = 1; b < a.length; b++) {
                ...
                c.attributes["cke-indentation"] =
                    c.attributes["cke-indentation"] ||
                    h.getElementIndentation(c);
                c.previous !== f &&
                    (h.chopDiscontinuousLists(e, d), d.push((e = [])));
                e.push(c);
            }
        ...
        chopDiscontinuousLists: function (a, b) {
            for (var c = {}, d = [[]], e, f = 0; f < a.length; f++) {
                ...
                g
                    ? ((n =
                          g.type.match(/alpha/) && 7 == g.index ? "alpha" : n),
                      (n =
