...
(function () {
    ...
    CKEDITOR.ui.balloonPanel = function (a, b) {
        ...
        for (var c in this.templateDefinitions)
            this.templates[c] = new CKEDITOR.template(
                this.templateDefinitions[c]
            );
        this.parts = {};
        this.focusables = {};
        this.showListeners = {};
    ...
    CKEDITOR.ui.balloonPanel.prototype = {
        ...
        attach: (function () {
            ...
            return function (p, l) {
                ...
                if (l instanceof CKEDITOR.dom.element || !l)
                    l = { focusElement: l };
                ...
                r
                    ? (CKEDITOR.tools.array.forEach(
                      ...
                      (g = this._getAlignments(r[0], d, e)),
                      1 < r.length &&
                          (g["bottom hcenter"] = this._getAlignments(
                              r[1],
                              d,
                              e
                          )["bottom hcenter"]),
                      (h = { "top hcenter": !0, "bottom hcenter": !0 }))
                    : (this._adjustElementRect(g, q ? m : t),
                ...
                !1 !== l.focusElement &&
                    (l.focusElement || this.parts.panel).focus();
            };
        })(),
        resize: function (a, b) {
            this.rect.width = a;
        ...
        setTriangle: function (a, b) {
            ...
            this.triangleSide &&
                ...
                c.removeClass(
                    "cke_balloon_triangle_align_" + this.triangleAlign
                ),
        ...
        deactivateShowListeners: function () {
            for (var a in this.activeShowListeners)
                this.deactivateShowListener(a);
        },
        destroy: function () {
