...
(function () {
    ...
    function n(a) {
        ...
        a.widgets.add("codeSnippet", {
            ...
            template:
                '\x3cpre\x3e\x3ccode class\x3d"' +
                b +
                '"\x3e\x3c/code\x3e\x3c/pre\x3e',
            dialog: "codeSnippet",
            ...
            highlight: function () {
                ...
                a._.codesnippet.highlighter.highlight(
                    c.code,
                    c.lang,
                    function (d) {
                        a.fire("lockSnapshot");
            ...
            data: function () {
                var a = this.data,
                    b = this.oldData;
                a.code &&
                    this.parts.code.setHtml(CKEDITOR.tools.htmlEncode(a.code));
                b &&
                    a.lang != b.lang &&
                    this.parts.code.removeClass("language-" + b.lang);
                a.lang &&
                    (this.parts.code.addClass("language-" + a.lang),
                    this.highlight());
            ...
            upcast: function (d, c) {
                if ("pre" == d.name) {
                    for (
                        var g = [], e = d.children, k, l = e.length - 1;
                        0 <= l;
                        l--
                    )
                        (k = e[l]),
                    ...
                    if (
                        ...
                        if (
                            (g = a._.codesnippet.langsRegex.exec(
                                f.attributes["class"]
                            ))
                        )
                            c.lang = g[1];
    ...
    CKEDITOR.plugins.add("codesnippet", {
        ...
        onLoad: function () {
            CKEDITOR.dialog.add(
                "codeSnippet",
                this.path + "dialogs/codesnippet.js"
            );
        },
        init: function (a) {
            a.ui.addButton &&
