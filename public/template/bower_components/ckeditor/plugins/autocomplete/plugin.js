...
(function () {
    function f(a, b) {
        ...
        this.commitKeystrokes = CKEDITOR.tools.array.isArray(c)
            ? c.slice()
            : [c];
        this._listeners = [];
        this.outputTemplate =
    ...
    f.prototype = {
        ...
        commit: function (a) {
            if (this.model.isActive) {
                this.close();
                if (null == a && ((a = this.model.selectedItemId), null == a))
                    return;
        ...
        getModel: function (a) {
            ...
            return new h(function (c, d) {
                return a.call(
                    this,
                    CKEDITOR.tools.extend({ autocomplete: b }, c),
                    d
                );
            });
        },
        ...
        attach: function () {
            this.element.on(
                ...
                function (a) {
                    (a = a.data
                        .getTarget()
                        .getAscendant(this.isItemElement, !0)) &&
