                    ...
                    setUp: function (b) {
                        function a(d) {
                            ...
                            if (!b.filter.check("figcaption"))
                                return CKEDITOR.tools.array.forEach(
                                    c,
                                    function (a) {
                                        a.removeListener();
                                    }
                    ...
                    _refreshCaption: function (b) {
                        ...
                        if (d)
                            g.getData() || b.equals(f)
                                ? (!b ||
                                      (b.equals(f) &&
                                          b.data("cke-caption-placeholder"))) &&
                                  c(this)
                                : this.parts.caption.data(
                                      "cke-caption-placeholder",
                                      this.editor.lang.imagebase
                                          .captionPlaceholder
                                  ),
                                a(f, !0);
                        else if (
            ...
            upload: (function () {
                var c = {
                    ...
                    _beginUpload: function (a, b) {
                        ...
                        if (
                            !1 !== a.fire("uploadStarted", b) &&
                            a.progressReporterType
                        )
                        ...
                        if ("undefined" !== typeof c)
                            if (null === c)
                                ...
                                var h =
                                    ...
                                    b = CKEDITOR.plugins.link.getLinkAttributes(
                                        b,
                                        c
                                    );
                                CKEDITOR.tools.isEmpty(b.set) ||
                                    h.setAttributes(b.set);
                                b.removed.length &&
