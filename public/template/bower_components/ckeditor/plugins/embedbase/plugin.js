...
(function () {
    var l = {
        ...
        sendRequest: function (e, c, d, a) {
            function b() {
                g &&
                    (g.remove(),
                    delete CKEDITOR._.jsonpCallbacks[h],
                    (g = null));
            }
            var k = {};
            c = c || {};
    ...
    CKEDITOR.plugins.add("embedbase", {
        ...
        init: function () {
            CKEDITOR.dialog.add(
                "embedBase",
                this.path + "dialogs/embedbase.js"
            );
        },
    });
            ...
            return {
                ...
                init: function () {
                    ...
                    this.on(
                        ...
                        function (a) {
                            if (!a.data.html) {
                                var b = this._responseToHtml(
                                    a.data.url,
                                    a.data.response
                                );
                                null !== b
                                    ? (a.data.html = b)
                                    : ((a.data.errorMessage = "unsupportedUrl"),
                                      a.cancel());
                            }
                        },
                        this,
