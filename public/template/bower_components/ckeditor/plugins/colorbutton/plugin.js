    ...
    init: function (e) {
            ...
            e.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                ...
                onOpen: function () {
                    ...
                    if (c) {
                        ...
                        !1 !== m.colorButton_enableAutomatic &&
        ...
        function z(a, d, g, r) {
            ...
            var l = m.colorButton_colors.split(","),
                ...
                q = e.plugins.colordialog && !1 !== m.colorButton_enableMore,
                k = l.length + (q ? 2 : 1),
                p = CKEDITOR.tools.addFunction(function (a, b) {
                    function c(a) {
                        var d = m["colorButton_" + b + "Style"];
                        e.removeStyle(
                            new CKEDITOR.style(d, { color: "inherit" })
                        );
                        d.childRule =
                            "back" == b
                                ? function (a) {
            ...
            for (g = 0; g < l.length; g++) {
                ...
                a.push(
                    ...
                    t[1] ? b : e.lang.colorbutton.colors[c] || c,
                    '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(',
                    p,
                    ",'",
                    c,
                    ...
                    [
                        {
                            ...
                            right: function (a) {
                                a.name = "span";
                                a.attributes.color &&
                                    (a.styles.color = a.attributes.color);
                    ...
                    [
                        {
                            ...
                            right: function (a) {
                                var d = new CKEDITOR.style(
                                    e.config.colorButton_backStyle,
