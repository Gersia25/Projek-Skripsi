                ...
                if (!d.equals(a.data.node) && d.getDirection())
                    ...
                    e &&
                        (d.hasClass(e[0])
                            ...
                            : d.hasClass(e[2]) &&
                              (d.removeClass(e[2]), d.addClass(e[0])));
        ...
        exec: function (a) {
            ...
            if (c) {
                for (
                    ...
                    for (
                        h = d[n].createIterator(),
                            h.enlargeBr = b != CKEDITOR.ENTER_BR;
                        (g = h.getNextParagraph(
                            b == CKEDITOR.ENTER_P ? "p" : "div"
                        ));
                        ...
                        if (!g.isReadOnly()) {
                            ...
                            if (
                                ...
                                e && l
                                    ...
                                    : r &&
                                      p &&
                                      g.setStyle("text-align", this.value);
                            }
                        }
                a.focus();
