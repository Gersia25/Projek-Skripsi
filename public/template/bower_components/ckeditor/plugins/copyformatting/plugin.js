...
(function () {
    ...
    function q(a) {
        ...
        this.filter = new CKEDITOR.filter(
            a,
            a.config.copyFormatting_allowRules
        );
        !0 === a.config.copyFormatting_allowRules &&
    ...
    CKEDITOR.plugins.add("copyformatting", {
        ...
        init: function (a) {
            ...
            a.copyFormatting.on("extractFormatting", function (e) {
                ...
                if (
                    !a.copyFormatting.filter.check(
                        new CKEDITOR.style(d),
                        !0,
                        !0
                    )
                )
                            ...
                            (f = c[h]),
                                ...
                                -1 === l(b.preservedElements, f.element)
                                    ...
                                    : u(f.element, e.data.styles) &&
                                      b._removeStylesFromElementInRange(
                                          d,
                                          f.element
                                      ),
                                d.moveToBookmark(g);
            ...
            a.copyFormatting.on(
                ...
                function (b) {
                    ...
                    "list" === c && a.copyFormatting._isContextAllowed("list")
                        ...
                        : "table" === c &&
                          a.copyFormatting._isContextAllowed("table")
    ...
    CKEDITOR.plugins.copyformatting = {
        ...
        _extractStylesFromRange: function (a, b) {
            for (
                var e = [], d = new CKEDITOR.dom.walker(b), c;
                (c = d.next());
            ...
            for (f = e(h); null != (g = c.exec(f)); )
                if (g.index + g[0].length >= a.startOffset)
                    return (
                        ...
                        0 === g.index &&
                            ((g = d(h, !0)), (m = g.node), (a = g.offset)),
                        c >= f.length &&
                            ((f = d(h)), (k = f.node), (c = f.offset)),
                        {
                            startNode: m,
                            startOffset: a,
                            endNode: k,
